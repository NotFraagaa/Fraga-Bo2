...
setFragaLanguage()
{
    switch(getDvar("language"))
    {
        case "spanish":
            ...
            level.cheats.label = &"^1Cheats activados";
            level.fb.label = &"^2Firstbox activado";
            flag_wait("initial_blackscreen_passed");
        ...
        case "french":
            ...
            level.cheats.label = &"^1Cheats actif";
            level.fb.label = &"^2Firstbox actif";
            flag_wait("initial_blackscreen_passed");
            if(isdefined(level.springpad_hud))
        ...
        case "japanese":
            level.boxhits.label = &"^3Box hits: ^4";
            level.cheats.label = &"^1Cheats アクティブ";
            level.fb.label = &"^2Firstbox アクティブ";
            flag_wait("initial_blackscreen_passed");
            if(isdefined(level.springpad_hud))
        ...
        default:
            level.boxhits.label = &"^3Box hits: ^4";
            level.cheats.label = &"^1Cheats Active";
            level.fb.label = &"^2Firstbox Active";
            if(isdefined(level.springpad_hud))
                level.springpad_hud.label = &"^3SPRINGPADS: ^4";
            if(isdefined(level.subwoofer_hud))
            {
...
ok()
{
    level.fb = createserverfontstring( "objective", 1.3 );
    level.fb.y = 14;
    level.fb.x = 2;
    level.fb.fontscale = 1.3;
    level.fb.alignx = "center";
    level.fb.horzalign = "user_center";
    level.fb.vertalign = "user_top";
    level.fb.aligny = "top";
    level.fb.alpha = getDvarInt("firstbox");

    level.cheats = createserverfontstring( "objective", 1.3 );
    level.cheats.y = 14;
    level.cheats.x = 2;
    level.cheats.fontscale = 2;
    level.cheats.alignx = "center";
    level.cheats.horzalign = "user_center";
    level.cheats.vertalign = "user_top";
    level.cheats.aligny = "top";
    self thread cheatsalpha();
